...
class MyDataset(AutoDriveDataset):
    ...
    def _get_db(self):
        ...
        for mask in tqdm(list(self.mask_list)):
            ...
            with open(label_path, 'r') as f:
                label = json.load(f)
            a= mask_path.split('\\')[-1].split('_')[0]
            if a== 'bdd':
                data = label['frames'][0]['objects']
                data = self.filter_data1(data)
