...
_C.DATASET.DATAROOT = r'F:\dataset\bdd100k_dark\images'  # the path of images folder
_C.DATASET.LABELROOT = r'F:\dataset\bdd100k_dark\det_gt'  # the path of det_annotations folder
_C.DATASET.MASKROOT = r'F:\dataset\bdd100k_dark\da_gt'  # the path of da_seg_annotations folder
_C.DATASET.LANEROOT = r'F:\dataset\bdd100k_dark\lane_gt'  # the path of ll_seg_annotations folder

#_C.DATASET.DATAROOT = r'F:\road\MyDataset\images'  # the path of images folder
#_C.DATASET.LABELROOT = r'F:\road\MyDataset\det_label'  # the path of det_annotations folder
#_C.DATASET.MASKROOT = r'F:\road\MyDataset\da_label'  # the path of da_seg_annotations folder
#_C.DATASET.LANEROOT = r'F:\road\MyDataset\ll_label'  # the path of ll_seg_annotations folder

# _C.DATASET.DATAROOT = '../BDD10k/images'       # the path of images folder
# _C.DATASET.LABELROOT = '../BDD10k/det'      # the path of det_annotations folder
# _C.DATASET.MASKROOT = '../BDD10k/da_label'                # the path of da_seg_annotations folder
# _C.DATASET.LANEROOT = '../BDD10k/ll_label'               # the path of ll_seg_annotations folder
...
_C.TRAIN.LRF = 0.1  # final OneCycleLR learning rate (lr0 * lrf) default:0.2
